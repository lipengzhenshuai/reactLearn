  ...
  return (
    <>
      <div
        ...
        className={`py-list-item ${
          wordType === WordTypeEnum.UPDOWN ? "active" : ""
        }`}
      >
        <span
          className="py-low1"
          dangerouslySetInnerHTML={{ __html: up_down }}
        ></span>
        <span>拼音上下</span>
      </div>
      <div
        ...
        data-value="1"
        className={`py-list-item ${
          wordType === WordTypeEnum.LEFTRIGHT ? "active" : ""
        }`}
      >
        <span
          className="py-low1"
          dangerouslySetInnerHTML={{ __html: left_right }}
        ></span>
        <span>拼音左右</span>
      </div>
      <div
        ...
        data-value="2"
        className={`py-list-item ${
          wordType === WordTypeEnum.FOURLINE ? "active" : ""
        }`}
      >
        <span
          className="py-low2"
          dangerouslySetInnerHTML={{ __html: four_line }}
        ></span>
        <span>四线三格</span>
      </div>
      <div
        ...
        className={`py-list-item ${
          wordType === WordTypeEnum.SQUARE ? "active" : ""
        }`}
      >
        <span
          className="py-low2"
      ...
      <div
        ...
        data-value="4"
        className={`py-list-item ${
          wordType === WordTypeEnum.COMBINE ? "active" : ""
        }`}
      >
